...
public class StartExercise1_Outdoor extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        startBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                    ...
                    String content = uname + "現在正在" + pname + "進行" + type +"運動";
                if (firstStartClick) {
        ...
        stopBtn.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                requestQueue = Volley.newRequestQueue(getApplicationContext());
                JsonObjectRequest jsonObjectRequest = new JsonObjectRequest
                        (Request.Method.GET, Url2 + "?uid=" + uid + "&ename=" + type + "&start_time=" + startTime + "&end_time=" + System.currentTimeMillis(), new Response.Listener<JSONObject>() {
                            @Override
                            public void onResponse(JSONObject response) {
                                Log.d("1111111", "onResponse");
...
//
                ...
                Intent intent = new Intent(StartExercise1_Outdoor.this, StartExercise2.class);
